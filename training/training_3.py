...
"""
    ...
    (For a different movement algorithm detection, see training_4)
"""
######################################################><
import os, sys
...
def loopFunction():
    ...
    display.addSecondaryInfo(("% s/t", 45.0))
    display.addSecondaryInfo(("Time:", time.clock()- gVariables.start_time))
    display.renderAgain()
    import timeit
    try:
        while(True):
